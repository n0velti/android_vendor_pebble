...
ALARM_PATH := vendor/pebble/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/pebble/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/pebble/prebuilt/common/media/audio/ringtones
